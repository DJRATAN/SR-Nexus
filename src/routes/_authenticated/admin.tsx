...
export const Route = createFileRoute("/_authenticated/admin")({
  head: () => ({ meta: [{ title: "Admin — Ryze" }, { name: "robots", content: "noindex" }] }),
  component: AdminPage,
});
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              <Label>Title</Label>
              <Input value={form.subject} onChange={(e) => setForm({ ...form, subject: e.target.value })} placeholder="e.g. Welcome to Ryze" />
            </div>
            <div>
              <Label>Email</Label>
